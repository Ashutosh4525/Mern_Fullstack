...
function Services(){
    ...
    <section id="services" style={{
        ...
        <Container >
             ...
             <Heading title="Services" description="Necessitatibus eius consequatur ex aliquid fuga eum quidem sint consectetur vel"/>
                
        
            <Row xs={1} md={2} lg={3} className="g-3 d-flex justify-center align-items-center" data-aos="fade-up" data-aos-delay="200" >
            {data.map((a)=>(
                <Col xs={12} key={a.id} >
                    <div className="pop" style={{position:"relative"}}>
                    <Cards icon={a.icon} title={a.title} description={a.description} ></Cards> 
                    <div className="popp" style={{position:"absolute", top:"-10px",right:"20px",display: a.display}} >
                    <Popular/>
                    </div>
                    </div>
            ...
            <Card className="d-flex align-items-center text-center p-5 mt-5" data-aos="fade-up" data-aos-delay="200" style={{ backgroundColor:"#131428", color:"white", boxShadow:"0 10px 30px rgba(0, 0, 0, 0.05)",borderRadius:"20px"}}>
