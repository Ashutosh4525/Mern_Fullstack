...
paymentRouter.post("/order", paymentValidator.createOrder,validate,Authverify, createOrder)
paymentRouter.post("/verify",paymentValidator.verifyPayment,validate, Authverify, verifyPayment)
