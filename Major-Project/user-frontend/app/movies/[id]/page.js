...
export default function MovieDetailPage() {
  ...
  return (
    <ProtectedRoute>
      <main className="relative min-h-screen bg-[#080808] px-6 pb-20 pt-28 text-white md:px-10">
        ...
        {loading || !movie ? (
          ...
          <section className="relative z-10 mx-auto grid max-w-7xl gap-10 lg:grid-cols-[320px_minmax(0,1fr)]">
